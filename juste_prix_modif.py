...
proposition = 0
compteur=1
#vérification de la proposition du joueur, tant que la proposition !=juste prix
...
if proposition != juste_prix:
    ...
    print("Félicitations! Tu as trouvé le juste prix en", compteur, "tentatives!", "Le juste prix était", juste_prix)